...
///// configure CustomPlot
    CustomPlotDialog::configureCustomPlot();
...
/// \param --
///
void CustomPlotDialog::onScatterStyleComboBoxChanged(int index) {
...
void CustomPlotDialog::onLineStyleComboBoxChanged(int index) {
    QCPGraph * currentGraph = ui->customPlot->graph(ui->graphIdComboBox->currentIndex());
    currentGraph->setLineStyle((QCPGraph::LineStyle)ui->lineStyleComboBox->itemData(index).toInt());
}
void CustomPlotDialog::onColorComboBoxChanged(int index) {
    QCPGraph * currentGraph = ui->customPlot->graph(ui->graphIdComboBox->currentIndex());
    QPen graphPen;
...
void CustomPlotDialog::onAutoscaleCheckBoxChanged(int choice) {
...
/// \param --
///
void CustomPlotDialog::onGraphIdChanged(int index) {
    if (index != -1) {
...
void CustomPlotDialog::onAddPlotButtonClicked() {
    CustomPlotDialog::insertNewGraph();
    CustomPlotDialog::updateGraphsIds();
}

void CustomPlotDialog::onDeletePlotButtonClicked() {
...
int CustomPlotDialog::insertNewGraph() {
...
void CustomPlotDialog::updateGraphsIds() {
...
QString CustomPlotDialog::getCanal() {
    //return canal;
...
int CustomPlotDialog::getComboSelected() {
    return comboSelected;
}

QVector<double> * CustomPlotDialog::getXVector() {
...
void CustomPlotDialog::setTarget(int cible) {
    target = cible;
...
/// \return
///
int CustomPlotDialog::getTarget() {
    return target;
}
